...
#include "../hscpp-example-utils/include/hscpp-example-utils/MemoryManager.h"
#include "../hscpp-example-utils/include/hscpp-example-utils/Ref.h"
...
int main(int, char**)
{
    ...
    swapper.AddLibrary(std::filesystem::current_path().parent_path() / "x64" / "Debug" / "imgui.lib");
