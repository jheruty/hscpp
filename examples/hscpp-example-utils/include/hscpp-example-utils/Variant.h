...
public:
    ...
    int8_t& AsRef()
    {
        return m_Value.int8_t_;
    }

    template <>
    int16_t& AsRef()
    {
        return m_Value.int16_t_;
    }

    template <>
    int32_t& AsRef()
    {
        return m_Value.int32_t_;
    }

    template <>
    int64_t& AsRef()
    {
        return m_Value.int64_t_;
    }

    template <>
    uint8_t& AsRef()
    {
        return m_Value.uint8_t_;
    }

    template <>
    uint16_t& AsRef()
    {
        return m_Value.uint16_t_;
    }

    template <>
    uint32_t& AsRef()
    {
        return m_Value.uint32_t_;
    }

    template <>
    uint64_t& AsRef()
    {
        return m_Value.uint64_t_;
    }
